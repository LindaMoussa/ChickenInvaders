...
function nextLevel(fires) {
  ...
  eggInterval = setInterval(function() {
    eggsDropLevel2();
  }, 1600);

  chickenInterval = window.setInterval(function() {
        ...
        if (res) {
          ...
          if (step == 20) {
            ...
            if (leftPos != 0 && topPos != 0) {
              ...
              //     countMeat++;
              //   }
              $(".winner").removeClass("deactivate");
              $(".winner").css("animation", "winnerAnim 5s ease-out forwards");
              $(".fireWorks").css("display", "block");
              $(".progressParent").toggle("deactivate");
              $(".userDataContainer").addClass("deactivate");
              $(".score").addClass("deactivate");
  ...
  if (rockeDiv.length != 0) {
    for (let i = 0; i < Eggs.length; i++) {
      ...
      if (res) {
        ...
        $("#brokenEgg" + BrokenEggCounter).css("top", "" + eggTop + "px");
        $("#brokenEgg" + BrokenEggCounter).css("left", "" + eggLeft + "px");
        // if (
        //   $("#brokenEgg" + i).offset().top == 0 ||
        //   $("#brokenEgg" + i).offset().left == 0
        // ) {
        //   $("#brokenEgg" + i).css("display", "none");
        // }
        console.log($("#brokenEgg" + BrokenEggCounter).offset().top);
        console.log($("#brokenEgg" + BrokenEggCounter).offset().left);
        $("#brokenEgg" + BrokenEggCounter).hide(4000);
